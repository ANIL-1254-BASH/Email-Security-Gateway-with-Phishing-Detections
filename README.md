# Email-Security-Gateway-with-Phishing-Detections
Internship Project for Codec Technologies Learn, implement, and test core
...
```bash
git clone https://github.com/ANIL-1254/Email-Security-Gateway-with-Phishing-Detection.git
cd Email-Security-Gateway-with-Phishing-Detection
